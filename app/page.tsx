  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section
          className="flex justify-center items-center relative overflow-hidden w-full py-20 md:py-28 lg:py-32 
              ...
              <div className="flex flex-col justify-center space-y-5">
                <div className="space-y-4">
                  <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none bg-gradient-to-b from-foreground to-foreground/80 text-transparent bg-clip-text">
                    Transforme dados em{" "}
                    <span className="text-primary">decisões de negócio</span>
                  </h1>
                  <p className="max-w-[600px] text-muted-foreground md:text-xl leading-relaxed mx-auto lg:mx-0">
                    Capture, processe e visualize métricas importantes do seu
                    negócio com webhooks personalizáveis. Unificando dados para
                    times de marketing, design, desenvolvimento e data science.
                  </p>
                </div>
        ...
        <section
          className="flex justify-center items-center relative w-full py-12 md:py-24 lg:py-32 border-t"
          id="solucoes"
        >
          <div className="absolute inset-0 bg-grid-pattern opacity-5"></div>
          <div className="container px-4 md:px-6 relative">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
              ...
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Empresas perdem milhões anualmente por não terem visibilidade
                sobre seus dados e métricas de negócio.
              </p>
            </div>
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 py-12 md:grid-cols-2 lg:grid-cols-3">
              <Card className="group border border-border bg-background/50 backdrop-blur-sm hover:bg-primary/5 transition-colors duration-300 hover:border-primary/20">
                ...
                <CardContent>
                  <p className="text-muted-foreground leading-relaxed">
                    Informações espalhadas em diferentes sistemas, dificultando
                    a visão completa do negócio e a tomada de decisões.
                  </p>
                </CardContent>
              </Card>
              <Card className="group border border-border bg-background/50 backdrop-blur-sm hover:bg-primary/5 transition-colors duration-300 hover:border-primary/20">
                ...
                <CardContent>
                  <p className="text-muted-foreground leading-relaxed">
                    Tomada de decisões baseada em intuição em vez de métricas
                    concretas, levando a resultados imprevisíveis e
                    ineficientes.
                  </p>
                </CardContent>
              </Card>
              <Card className="group border border-border bg-background/50 backdrop-blur-sm hover:bg-primary/5 transition-colors duration-300 hover:border-primary/20">
                ...
                <CardContent>
                  <p className="text-muted-foreground leading-relaxed">
                    Dificuldade para conectar diferentes sistemas e coletar
                    dados de múltiplas fontes, gerando silos de informação.
                  </p>
                </CardContent>
              </Card>
              <Card className="group border border-border bg-background/50 backdrop-blur-sm hover:bg-primary/5 transition-colors duration-300 hover:border-primary/20">
                ...
                <CardContent>
                  <p className="text-muted-foreground leading-relaxed">
                    Preocupações com a proteção de dados e conformidade com
                    regulamentações como LGPD, expondo a empresa a riscos.
                  </p>
                </CardContent>
              </Card>
              <Card className="group border border-border bg-background/50 backdrop-blur-sm hover:bg-primary/5 transition-colors duration-300 hover:border-primary/20">
                ...
                <CardContent>
                  <p className="text-muted-foreground leading-relaxed">
                    Falta de profundidade nas análises e ausência de insights
                    acionáveis baseados em inteligência artificial.
                  </p>
                </CardContent>
              </Card>
              <Card className="group border border-border bg-background/50 backdrop-blur-sm hover:bg-primary/5 transition-colors duration-300 hover:border-primary/20">
                ...
                <CardContent>
                  <p className="text-muted-foreground leading-relaxed">
                    Soluções que não acompanham o crescimento do seu negócio,
                    tornando-se obsoletas e custosas com o tempo.
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Metrio unifica seus dados, fornece insights valiosos e
                  automatiza decisões baseadas em dados.
                </p>
              </div>
            </div>
                ...
                <ul className="grid gap-6">
                  <li className="flex gap-4 items-start">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Colete dados de qualquer fonte com nossos webhooks
                        flexíveis e personalizáveis, sem precisar de
                  ...
                  <li className="flex gap-4 items-start">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Receba notificações instantâneas quando eventos
                        importantes ocorrerem, permitindo ações imediatas.
                      </p>
                    </div>
                  </li>
                  <li className="flex gap-4 items-start">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Nossa inteligência artificial analisa seus dados e
                        fornece recomendações acionáveis para melhorar seu
                        negócio.
                      </p>
                    </div>
                  </li>
                  <li className="flex gap-4 items-start">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        ...
                        autenticação de dois fatores e conformidade com LGPD.
                      </p>
                    </div>
                  </li>
                </ul>
        ...
        {/* Como Funciona */}
        <section
          className="flex justify-center items-center relative w-full py-16 md:py-24 lg:py-32 bg-gradient-to-b from-background to-primary/5"
          id="como-funciona"
        >
          <div className="absolute inset-0 bg-grid-pattern opacity-5"></div>
          <div className="container px-4 md:px-6 relative">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              ...
              <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight max-w-[800px] mb-4">
                Colete, processe e visualize dados em{" "}
                <span className="text-primary">4 etapas simples</span>
              </h2>
              <p className="max-w-[900px] text-muted-foreground md:text-lg mb-12">
                Nossa plataforma foi desenhada para ser simples de integrar e
              ...
              <div className="mx-auto max-w-4xl space-y-16 lg:space-y-24 relative">
                ...
                <div className="group relative">
                  <div className="lg:grid lg:grid-cols-2 lg:gap-12 items-center">
                    <div className="relative mb-8 lg:mb-0">
                      <div className="absolute -top-2 -left-2 w-12 h-12 rounded-full bg-primary text-background flex items-center justify-center font-bold text-xl shadow-lg z-10 lg:left-auto lg:right-0 lg:translate-x-1/2">
                        1
                      </div>
                      <div className="rounded-xl p-6 pb-8 bg-background border border-border shadow-lg relative z-0">
                        ...
                        <p className="text-muted-foreground mb-4">
                          Crie webhooks personalizados e defina quais eventos
                          você deseja monitorar em nossa interface intuitiva.
                        </p>
                        <ul className="space-y-2">
                          <li className="flex items-center gap-2">
                            <CheckCircle2 className="h-4 w-4 text-primary flex-shrink-0" />
                            <span className="text-sm">
                              Interface low-code para fácil configuração
                            </span>
                          </li>
                          <li className="flex items-center gap-2">
                            <CheckCircle2 className="h-4 w-4 text-primary flex-shrink-0" />
                            <span className="text-sm">
                              Geração automática de tokens de segurança
                            </span>
                          </li>
                          <li className="flex items-center gap-2">
                            <CheckCircle2 className="h-4 w-4 text-primary flex-shrink-0" />
                            <span className="text-sm">
                              Personalização de quais dados coletar
                            </span>
                          </li>
                        </ul>
                      </div>
                ...
                <div className="group relative">
                  <div className="lg:grid lg:grid-cols-2 lg:gap-12 items-center">
                    ...
                    <div className="relative mb-8 lg:mb-0">
                      <div className="absolute -top-2 -left-2 w-12 h-12 rounded-full bg-primary text-background flex items-center justify-center font-bold text-xl shadow-lg z-10 lg:right-auto lg:left-0 lg:-translate-x-1/2">
                        2
                      </div>
                      <div className="rounded-xl p-6 pb-8 bg-background border border-border shadow-lg relative z-0">
                        <h3 className="text-xl font-bold mb-3">
                        ...
                        <p className="text-muted-foreground mb-4">
                          Adicione o código gerado ao seu site ou sistema para
                          começar a capturar eventos importantes.
                        </p>
                        <ul className="space-y-2">
                          <li className="flex items-center gap-2">
                            <CheckCircle2 className="h-4 w-4 text-primary flex-shrink-0" />
                          ...
                          <li className="flex items-center gap-2">
                            <CheckCircle2 className="h-4 w-4 text-primary flex-shrink-0" />
                            <span className="text-sm">
                              Suporte para diversas linguagens (JS, PHP, Python,
                              etc.)
                            </span>
                          </li>
                          <li className="flex items-center gap-2">
                            <CheckCircle2 className="h-4 w-4 text-primary flex-shrink-0" />
                            <span className="text-sm">
                              Exemplos de integrações comuns pré-configurados
                            </span>
                          </li>
                        </ul>
                      </div>
                  ...
                  <div className="lg:grid lg:grid-cols-2 lg:gap-12 items-center">
                    <div className="relative mb-8 lg:mb-0">
                      ...
                      <div className="rounded-xl p-6 pb-8 bg-background border border-border shadow-lg relative z-0">
                        ...
                        <p className="text-muted-foreground mb-4">
                          Nosso sistema processa e armazena automaticamente os
                          eventos recebidos para análises detalhadas.
                        </p>
                        <ul className="space-y-2">
                          <li className="flex items-center gap-2">
                            <CheckCircle2 className="h-4 w-4 text-primary flex-shrink-0" />
                  ...
                  <div className="lg:grid lg:grid-cols-2 lg:gap-12 items-center">
                    ...
                    <div className="relative mb-8 lg:mb-0">
                      ...
                      <div className="rounded-xl p-6 pb-8 bg-background border border-border shadow-lg relative z-0">
                        ...
                        <p className="text-muted-foreground mb-4">
                          Acesse dashboards interativos personalizáveis e
                        ...
                        <ul className="space-y-2">
                          ...
                          <li className="flex items-center gap-2">
                            <CheckCircle2 className="h-4 w-4 text-primary flex-shrink-0" />
                            <span className="text-sm">
                              Análises de tendências e previsões por IA
                            </span>
                          </li>
                          <li className="flex items-center gap-2">
                            <CheckCircle2 className="h-4 w-4 text-primary flex-shrink-0" />
                            <span className="text-sm">
                              Compartilhamento de relatórios entre times
                            </span>
                          </li>
                        </ul>
                      </div>
        ...
        <section className="flex justify-center items-center relative w-full py-16 md:py-24 lg:py-32 border-t">
          ...
          <div className="container px-4 md:px-6 relative">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
              ...
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Transforme dados em ações concretas para todas as áreas do seu
                negócio.
              </p>
            </div>
                ...
                <div className="group relative overflow-hidden rounded-xl hover:shadow-lg transition-all duration-300 border border-border">
                  <div className="flex flex-col md:flex-row">
                    ...
                    <div className="p-6 md:w-2/3">
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        Analise o comportamento dos usuários para criar
                        campanhas mais eficazes. Identifique quais promoções
                        geram mais conversões em diferentes períodos, como datas
                        comemorativas, otimizando o ROI das campanhas.
                      </p>
                ...
                <div className="group relative overflow-hidden rounded-xl hover:shadow-lg transition-all duration-300 border border-border">
                  <div className="flex flex-col md:flex-row">
                    ...
                    <div className="p-6 md:w-2/3">
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        Monitore logs de erro em tempo real para identificar e
                        corrigir problemas antes que afetem muitos usuários.
                        Rastreie o desempenho do seu sistema e otimize a
                        experiência do usuário com base em dados reais.
                      </p>
                      <div className="mt-6 space-y-2">
                        <div className="flex items-center gap-2">
                          <CheckCircle2 className="h-4 w-4 text-primary" />
                ...
                <div className="group relative overflow-hidden rounded-xl hover:shadow-lg transition-all duration-300 border border-border">
                  <div className="flex flex-col md:flex-row">
                    ...
                    <div className="p-6 md:w-2/3">
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        Identifique padrões de uso e comportamento do cliente
                        para gerar insights valiosos. Descubra correlações entre
                        eventos diferentes e crie modelos preditivos para
                      ...
                      <div className="mt-6 space-y-2">
                        <div className="flex items-center gap-2">
                          <CheckCircle2 className="h-4 w-4 text-primary" />
                          <span className="text-sm">
                            Modelagem preditiva de comportamentos
                          </span>
                        </div>
                        <div className="flex items-center gap-2">
                          <CheckCircle2 className="h-4 w-4 text-primary" />
                ...
                <div className="group relative overflow-hidden rounded-xl hover:shadow-lg transition-all duration-300 border border-border">
                  <div className="flex flex-col md:flex-row">
                    ...
                    <div className="p-6 md:w-2/3">
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        Otimize interfaces com base em dados reais de interação.
                        Descubra quais elementos geram mais engajamento (como um
                        botão verde recebendo mais cliques que um roxo) e crie
                      ...
                      <div className="mt-6 space-y-2">
                        ...
                        <div className="flex items-center gap-2">
                          <CheckCircle2 className="h-4 w-4 text-primary" />
                          <span className="text-sm">
                            Análise de heatmaps de interação
                          </span>
                        </div>
                        <div className="flex items-center gap-2">
                          <CheckCircle2 className="h-4 w-4 text-primary" />
                          <span className="text-sm">
                            Otimização de jornadas de conversão
                          </span>
                        </div>
                      </div>
                    </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  ...
                  para transformar seus dados em resultados.
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 py-12 md:grid-cols-2 lg:grid-cols-3">
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Visualize suas métricas mais importantes em dashboards
                    interativos, com filtros personalizáveis e histórico
                    temporal detalhado.
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Configure webhooks para capturar qualquer evento do seu
                    sistema: compras, cadastros, logins, interações específicas
                    ou logs de erro.
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Utilize nossos webhooks para integração direta nos seus
                    sistemas, com código pronto para implementação e
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Nossa IA identifica tendências, anomalias e oportunidades em
                    seus dados, gerando previsões e recomendações acionáveis.
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Proteja seus dados com criptografia, tokens de acesso
                    seguros para webhooks, além de controles de permissão
                    granulares.
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Compartilhe insights e métricas com diferentes
                    departamentos, permitindo que marketing, design,
                    desenvolvimento e data science trabalhem juntos.
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Quando o Metrio for lançado, ofereceremos planos flexíveis
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Estamos construindo o Metrio para resolver problemas reais de
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-2 lg:grid-cols-3">
              <Card className="border-2 border-muted">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    "Acreditamos que decisões baseadas em dados transformam
                    negócios. Nossa missão é tornar isso acessível para todas as
              ...
              <Card className="border-2 border-muted">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    "Queremos eliminar a complexidade técnica das integrações.
                    Mesmo as equipes sem profundo conhecimento técnico merecem
              ...
              <Card className="border-2 border-muted">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    "Estamos desenvolvendo recursos de inteligência artificial
                    que não apenas mostram dados, mas geram insights acionáveis
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto max-w-3xl space-y-4 py-12">
              <Card>
                <CardHeader>
                  <CardTitle>
                    O que são webhooks e como eles funcionam na plataforma?
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground">
                    Webhooks são como "ouvintes" que você coloca no seu sistema
                    para capturar eventos específicos. Na nossa plataforma, você
                    configura um webhook, recebe um código para inserir no seu
                    site/aplicação, e sempre que um evento ocorrer (como uma
                    compra ou login), esse código envia automaticamente os dados
                    para nossa plataforma, onde são processados e transformados
                    em métricas.
                  </p>
                </CardContent>
              </Card>
              <Card>
                <CardHeader>
                  <CardTitle>
                    Preciso ter conhecimento técnico para configurar os
                    webhooks?
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground">
                    Não necessariamente. Nossa plataforma oferece uma interface
                    low-code/no-code para configurar os webhooks, gerando
                    automaticamente o código que você precisará inserir no seu
                    sistema. Para implementações mais complexas, fornecemos
                    documentação detalhada e exemplos para várias linguagens de
                    programação, além de suporte técnico para ajudar na
                    integração.
                  </p>
                </CardContent>
              </Card>
              <Card>
                <CardHeader>
                  <CardTitle>
                    Como a integração entre times funciona na prática?
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground">
                    Nossa plataforma centraliza dados de diferentes fontes,
                    permitindo que cada equipe visualize as métricas relevantes
                    para seu trabalho. Por exemplo, o time de design pode
                    analisar o comportamento dos usuários em relação a elementos
                    visuais, enquanto o marketing acompanha as taxas de
                    conversão. Todos trabalham com os mesmos dados, mas com
                    visões personalizadas que ajudam a tomar decisões mais
                    eficazes.
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Utilizamos criptografia de ponta a ponta, tokens de
                    autenticação exclusivos para cada webhook, e seguimos as
                    melhores práticas de segurança. Somos compatíveis com LGPD e
                    outras regulamentações de privacidade, e realizamos
                    auditorias de segurança regulares para garantir a proteção
                    dos seus dados.
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    A maioria dos clientes começa a obter insights valiosos em
                    menos de uma semana após a implementação. Uma vez que os
                    webhooks estão configurados, os dados começam a fluir
                    imediatamente. Nossa equipe de onboarding ajuda a configurar
                    tudo rapidamente, e nossos dashboards pré-configurados
                    fornecem valor desde o primeiro dia.
                  </p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Estamos desenvolvendo algo especial. Faça seu pré-cadastro
                  para acesso antecipado e bônus exclusivos.
                </p>
              </div>
