...
import { WebhooksHeader } from "@/app/dashboard/webhooks/components/webhooks-header";
import {
  WebhooksList,
  Webhook as WebhookFromList,
} from "@/app/dashboard/webhooks/components/webhooks-list";
import { WebhooksMonitor } from "@/app/dashboard/webhooks/components/webhooks-monitor";
import { WebhooksLogs } from "@/app/dashboard/webhooks/components/webhooks-logs";
import { WebhooksDetails } from "@/app/dashboard/webhooks/components/webhooks-details";
import {
  Card,
  CardContent,
  CardDescription,
...
export default function WebhooksPage() {
  const [selectedWebhook, setSelectedWebhook] = useState<WebhookDetails | null>(
    null
  );
  const [activeView, setActiveView] = useState<string>("manage");
    ...
    const webhookForDetails: WebhookDetails = {
      ...
      deliveryHistory: [
        ...
        },
        {
          ...
          error:
            webhook.failureCount > 0
              ? "O servidor retornou um erro interno (500)"
              : undefined,
        },
      ],
    };
              ...
              <div className="md:col-span-4">
                ...
                <Card className="mt-5">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Integrações comuns que você pode configurar
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      ...
                      >
                        ...
                        <div className="flex flex-col items-start text-left">
                          ...
                          <span className="text-xs text-muted-foreground">
                            Sincronize com seu repositório
                          </span>
                        </div>
                      ...
                      <Button
                        variant="outline"
                        className="h-auto py-3 px-4 justify-start col-span-2"
                        asChild
                      >
                        <Link href="/dashboard/webhooks/new">
                          ...
                          <div className="flex flex-col items-start text-left">
                            ...
                            <span className="text-xs text-muted-foreground">
                              Crie webhooks customizados com UUIDs únicos
                            </span>
                          </div>
                  ...
                  {selectedWebhook ? (
                    ...
                    <div className="rounded-md border border-dashed p-8 text-center">
                      ...
                      <p className="text-muted-foreground">
                        Escolha um webhook da lista para visualizar detalhes e
                    ...
                    <CardContent>
                      <div className="space-y-4 text-sm">
                        <div className="flex gap-2">
                          ...
                          <p>
                            Use <strong>variáveis de ambiente</strong> para
                            gerenciar suas chaves secretas e UUIDs de webhooks.
                          </p>
                        </div>
                        ...
                        <div className="flex gap-2">
                          ...
                          <p>
                            Configure <strong>nomes técnicos</strong> para
                            facilitar a referência aos UUIDs dos webhooks no seu
                            código.
                          </p>
                        </div>
                        ...
                        <div className="flex gap-2">
                          ...
                          <p>
                            Consulte nossa <strong>documentação</strong> para
                            melhores práticas na integração de webhooks.
                          </p>
                        </div>
                        ...
                        <div className="flex gap-2">
                          ...
                          <p>
                            Utilize o <strong>SDK personalizado</strong> para
                            simplificar a implementação dos webhooks em seu
                            projeto.
                          </p>
                        </div>
                        ...
                        <Button
                          variant="ghost"
                          size="sm"
                          className="ml-6 h-7 text-xs px-2"
                        >
                          Ver mais dicas
                        </Button>
                      </div>
  ...
  return (
    <div className="flex flex-col gap-5">
      <WebhooksHeader activeView={activeView} setActiveView={setActiveView} />
