...
// Tipagem básica para project
interface Project {
  id: string;
  name: string;
}

// Tipagem estendida para sessão com activeProject
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      try {
        ...
        // Redirecionar para lista de webhooks
        console.log("Redirecionando para lista de webhooks...");
                ...
                <div className="flex gap-2">
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      setFormData({
                        ...
                        hookName: value,
                        url: value
                          ? `https://api.metrics-saas.com/${value}`
                          : "",
                      });
                    }}
                    className="flex-1"
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p>
                          Nome técnico que será usado na URL (apenas letras,
                          números e traços)
                        </p>
                      </TooltipContent>
                    </Tooltip>
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <Input
                    ...
                    value={
                      formData.hookName
                        ? `https://api.metrics-saas.com/${formData.hookName}`
                        : ""
                    }
                        ...
                        <Button
                          ...
                          onClick={() => {
                            ...
                            toast({
                              title: "URL copiada",
                              description:
                                "A URL do webhook foi copiada para a área de transferência.",
                              duration: 3000,
                            });
                          }}
                ...
                <div className="flex gap-2">
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p>
                          Chave secreta que será enviada no corpo da requisição
                          para validação
                        </p>
                      </TooltipContent>
                    </Tooltip>
            ...
            <div className="flex items-center justify-between pt-2">
              ...
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    handleSwitchChange("isShared", checked)
                  }
                />
                <Label htmlFor="webhook-shared">
          ...
          <div className="pt-4">
            <div className="flex flex-col space-y-2">
              ...
              <Alert>
                ...
                <AlertDescription>
                  Defina os campos que você espera receber nas requisições. O
                  campo "keyHook" é obrigatório para autenticação e já foi
            ...
            <div className="space-y-4 mt-6">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    handleSwitchChange("retryOnFailure", checked)
                  }
                />
              </div>
