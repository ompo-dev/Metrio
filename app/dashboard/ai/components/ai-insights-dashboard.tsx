      ...
      <Tabs defaultValue="insights" className="space-y-4">
        ...
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex gap-2">
            ...
            <Button
              variant={
                insightFilter === "opportunities" ? "default" : "outline"
              }
              size="sm"
            ...
            <Card className="border-l-4 border-l-primary">
              ...
              <CardContent>
                <div className="flex items-start space-x-4">
                  ...
                  <div className="space-y-2">
                    <p className="text-sm">
                      Usuários que acessam via dispositivos móveis têm 2.5x mais
                      chances de finalizar compras quando recebem notificações
                      push.
                    </p>
            ...
            <Card className="border-l-4 border-l-destructive">
              ...
              <CardContent>
                <div className="flex items-start space-x-4">
                  ...
                  <div className="space-y-2">
                    <p className="text-sm">
                      A taxa de conversão de visualizações para compras caiu 8%
                      na última semana. Recomendamos revisar a jornada de
                      compra.
                    </p>
                    <div className="flex items-center gap-1">
            ...
            <Card className="border-l-4 border-l-blue-500">
              ...
              <CardContent>
                <div className="flex items-start space-x-4">
                  ...
                  <div className="space-y-2">
                    <p className="text-sm">
                      Usuários tendem a abandonar o carrinho após 3 minutos de
                      inatividade. Recomendamos implementar lembretes
                      automáticos.
                    </p>
                    <div className="flex items-center gap-1">
                      <Badge className="bg-emerald-50 text-emerald-700 border-emerald-200">
          ...
          <div className="grid gap-4 md:grid-cols-7">
            <Card className="col-span-3">
              <CardHeader>
                ...
                <CardDescription>
                  Distribuição de sentimentos baseada em feedback e interações
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="col-span-4">
              <CardHeader>
                ...
                <CardDescription>
                  Análise de sentimentos em comentários e feedback
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="rounded-lg border p-3">
                  ...
                  <p className="mt-2 text-sm text-muted-foreground">
                    "Adorei a nova interface! Muito mais fácil de encontrar o
                    que preciso e finalizar minhas compras."
                  </p>
                </div>
                <div className="rounded-lg border p-3">
                  <div className="flex items-center justify-between">
                  ...
                  <p className="mt-2 text-sm text-muted-foreground">
                    "O produto chegou no prazo, mas a embalagem estava um pouco
                    danificada. O produto em si está funcionando bem."
                  </p>
                </div>
                <div className="rounded-lg border p-3">
                  <div className="flex items-center justify-between">
                  ...
                  <p className="mt-2 text-sm text-muted-foreground">
                    "Tive problemas com o pagamento, tentei várias vezes e não
                    consegui finalizar a compra. Precisei entrar em contato com
                    o suporte."
                  </p>
                </div>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent>
                <div className="flex items-start space-x-4">
                  ...
                  <div className="space-y-2">
                    <p className="text-sm">
                      Os cadastros via mobile aumentaram 23% em relação ao mês
                      anterior, indicando uma tendência de crescimento neste
                      canal.
                    </p>
                    <Badge className="bg-primary/20 text-primary hover:bg-primary/30">
                      Tendência Alta
            ...
            <Card>
              ...
              <CardContent>
                <div className="flex items-start space-x-4">
                  ...
                  <div className="space-y-2">
                    <p className="text-sm">
                      Detectamos um aumento de 35% nas compras durante os finais
                      de semana, especialmente entre 10h e 14h.
                    </p>
                    <Badge className="bg-primary/20 text-primary hover:bg-primary/30">
                      Padrão Confirmado
                    </Badge>
            ...
            <Card>
              ...
              <CardContent>
                <div className="flex items-start space-x-4">
                  ...
                  <div className="space-y-2">
                    <p className="text-sm">
                      Usuários que visitam a página de blog antes da página de
                      produtos têm 45% mais chances de finalizar uma compra.
                    </p>
                    <Badge className="bg-primary/20 text-primary hover:bg-primary/30">
                      Correlação Forte
                    </Badge>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Padrões incomuns identificados nos seus dados que podem
                  requerer atenção
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="rounded-lg border p-3">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Queda abrupta de 32% nas conversões entre 15/10 e 18/10.
                      Coincide com problemas reportados no gateway de pagamento.
                    </p>
                  ...
                  <div className="rounded-lg border p-3">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Aumento de 300% no tráfego em 22/10 às 14h. Origem
                      identificada: campanha de marketing não documentada.
                    </p>
                    <Button variant="link" className="p-0 h-auto mt-2">
                      Investigar <ArrowRight className="ml-1 h-4 w-4" />
                    </Button>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Estimativa do impacto das anomalias detectadas
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Estimativa de perda de receita: R$ 12.500,00
                    </p>
                  </div>
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Aproximadamente 850 usuários afetados
                    </p>
                  </div>
                  <div className="rounded-lg bg-muted p-3 mt-4">
                    ...
                    <p className="text-xs">
                      Implementar monitoramento em tempo real para o gateway de
                      pagamento e criar um plano de contingência para falhas
                      similares no futuro.
                    </p>
                  </div>
                </div>
