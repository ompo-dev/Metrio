...
const generateReport = async (topic: string): Promise<string> => {
  return new Promise((resolve) => {
    setTimeout(() => {
      resolve(
        `Relatório detalhado sobre ${topic} gerado com sucesso. Você pode baixá-lo ou compartilhar diretamente pelo menu de opções.`
      );
    }, 2000);
  });
};
...
const analyzeData = async (period: string): Promise<string> => {
  return new Promise((resolve) => {
    setTimeout(() => {
      resolve(
        `Análise completa dos dados do período ${period}. Foram encontradas 3 anomalias e 5 oportunidades de crescimento.`
      );
    }, 2500);
  });
};
...
export function AIAssistant() {
  ...
  const [messages, setMessages] = React.useState<Message[]>([
    {
      ...
      type: "assistant",
      content:
        "Olá! Sou seu assistente de análise de dados. Como posso ajudar você hoje?",
      timestamp: new Date(),
    },
  ]);
  ...
  const addMessage = async (
    ...
    if (type === "user") {
      ...
      try {
        ...
        if (
          content.toLowerCase().includes("gerar relatório") ||
          content.toLowerCase().includes("relatório sobre")
        ) {
          const topic = content
            .replace(
              /.*(?:relatório sobre|gerar relatório|relatório de|relatório para)/i,
              ""
            )
            .trim();
          ...
          content.toLowerCase().includes("analisar dados") ||
          content.toLowerCase().includes("análise de período")
        ) {
  ...
  const applyTemplate = (templateId: string) => {
    ...
    if (template) {
      addMessage(
        `Por favor, realize uma ${template.title.toLowerCase()} completa dos meus dados.`,
        "user"
      );
    }
  };
            ...
            >
              <div className="px-4 border-b">
                <TabsList className="w-full justify-start h-10 bg-transparent mb-0 pl-0">
                  <TabsTrigger
                    value="chat"
                    className="data-[state=active]:bg-muted rounded-none data-[state=active]:border-b-2 data-[state=active]:border-primary"
                  >
              ...
              <TabsContent
                value="chat"
                className="flex-1 flex flex-col data-[state=active]:flex pt-0 px-0 pb-0 m-0"
              >
                ...
                <div className="border-t p-3">
                  ...
                  <div className="mt-2 text-xs text-muted-foreground text-center">
                    <p>
                      Digite "analisar dados" ou "gerar relatório" para análises
                      avançadas
                    </p>
                  </div>
                </div>
              ...
              <TabsContent
                value="templates"
                className="flex-1 overflow-auto p-4 data-[state=active]:flex flex-col"
              >
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <div className="text-left">
                        ...
                        <p className="text-xs text-muted-foreground">
                          Comparação de taxas de conversão por canal
                        </p>
                      </div>
                    </Button>
                    <Button
                    ...
                    >
                      ...
                      <div className="text-left">
                        ...
                        <p className="text-xs text-muted-foreground">
                          Análise de segmentos de clientes por valor
                        </p>
                      </div>
                    </Button>
                  </div>
              ...
              <TabsContent
                value="settings"
                className="p-4 data-[state=active]:flex flex-col"
              >
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      O modelo Balanceado oferece um equilíbrio entre precisão e
                      criatividade nas respostas.
                    </p>
                  </div>
