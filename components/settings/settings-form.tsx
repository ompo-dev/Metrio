...
import { Save, Check, CreditCard, Plus, Camera, Trash2, Bell, Calendar, Globe, ShieldCheck, User, BuildingIcon, LogOut } from "lucide-react"
      ...
      <TabsContent value="profile" className="space-y-4">
          ...
          <CardContent className="space-y-6">
            <div className="flex items-center space-x-6">
              ...
              <div className="space-y-2">
                <Button variant="outline" size="sm" className="w-full justify-start text-sm transition-all hover:border-primary/50">
                  <Camera className="h-4 w-4 mr-2" />
                  Alterar Foto
                </Button>
                <Button variant="outline" size="sm" className="w-full justify-start text-sm text-destructive border-destructive/20 hover:bg-destructive/10 hover:text-destructive hover:border-destructive/30 transition-all">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                <p className="text-xs text-muted-foreground">Este email será usado para notificações e login</p>
              </div>
        ...
        <Card className="overflow-hidden border-primary/10 shadow-sm">
          <CardHeader>
            ...
            <CardDescription>Defina suas preferências de idioma e região</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <Label htmlFor="language">Idioma</Label>
                <select id="language" className="w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2">
              ...
              <div className="space-y-2">
                ...
                <select id="timezone" className="w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2">
        ...
        <Card className="overflow-hidden border-destructive/20 shadow-sm">
          ...
          <CardContent>
            <div className="space-y-4">
              <Button variant="outline" className="text-destructive border-destructive/20 hover:bg-destructive/10 hover:text-destructive hover:border-destructive/30">
        ...
        <Card className="overflow-hidden border-primary/10 shadow-sm">
          ...
          <CardContent className="space-y-6">
            <div className="space-y-4">
              <div className="flex items-center">
                <h3 className="text-base font-medium flex items-center">
                  <Badge variant="outline" className="mr-2 bg-primary/10 text-primary border-primary/20">Email</Badge>
              ...
              <div className="space-y-4 pl-2 border-l-2 border-primary/10">
                <div className="flex items-center justify-between p-3 rounded-lg hover:bg-muted/50 transition-all">
                  <div className="space-y-0.5">
                    <Label htmlFor="email-alerts" className="font-medium">Alertas de Métricas</Label>
                    <p className="text-sm text-muted-foreground">Receba alertas quando métricas importantes mudarem</p>
                  </div>
                  <Switch 
                    id="email-alerts" 
                ...
                <div className="flex items-center justify-between p-3 rounded-lg hover:bg-muted/50 transition-all">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">Receba um resumo semanal das suas métricas</p>
                  </div>
                  <Switch 
                    id="email-reports" 
                ...
                <div className="flex items-center justify-between p-3 rounded-lg hover:bg-muted/50 transition-all">
                  <div className="space-y-0.5">
                    <Label htmlFor="email-marketing" className="font-medium">Novidades e Atualizações</Label>
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                <h3 className="text-base font-medium flex items-center">
                  <Badge variant="outline" className="mr-2 bg-primary/10 text-primary border-primary/20">App</Badge>
              ...
              <div className="space-y-4 pl-2 border-l-2 border-primary/10">
                <div className="flex items-center justify-between p-3 rounded-lg hover:bg-muted/50 transition-all">
                  <div className="space-y-0.5">
                    <Label htmlFor="app-alerts" className="font-medium">Alertas em Tempo Real</Label>
                    <p className="text-sm text-muted-foreground">Receba alertas no aplicativo em tempo real</p>
                  </div>
                  <Switch 
                    id="app-alerts" 
                    checked={formState.notifications.appAlerts}
                    onCheckedChange={(checked) => handleNotificationChange('appAlerts', checked)}
                    className="data-[state=checked]:bg-primary"
                  />
                </div>
                <div className="flex items-center justify-between p-3 rounded-lg hover:bg-muted/50 transition-all">
                  <div className="space-y-0.5">
                    <Label htmlFor="app-sounds" className="font-medium">Sons de Notificação</Label>
                  ...
                  <Switch 
                    ...
                    onCheckedChange={(checked) => handleNotificationChange('appSounds', checked)}
                    className="data-[state=checked]:bg-primary"
                  />
                </div>
              </div>
          ...
          <CardFooter className="flex justify-between border-t px-6 py-4">
            <div className="flex items-center text-sm text-muted-foreground">
              <Bell className="h-4 w-4 mr-2" />
              As configurações de notificação são sincronizadas em todos os dispositivos
            </div>
            <Button 
          ...
          <CardContent className="space-y-4">
            <div className="rounded-lg border p-4 bg-gradient-to-r from-primary/5 to-primary/10">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">R$ 499,00/mês - Renovação em 15/11/2023</p>
                </div>
              ...
              <div className="mt-4 flex space-x-2">
                <Button variant="outline" className="transition-all hover:border-primary/50">Alterar Plano</Button>
                <Button variant="outline" className="text-destructive border-destructive/20 hover:bg-destructive/10 hover:text-destructive hover:border-destructive/30 transition-all">
                  Cancelar Assinatura
                </Button>
              </div>
            </div>
            <div className="space-y-2">
              ...
              <div className="rounded-lg border p-4 bg-card transition-all hover:shadow-sm hover:border-primary/20">
                ...
                <div className="mt-4 flex space-x-2">
                  <Button variant="outline" size="sm" className="transition-all hover:border-primary/50">
                    Editar
                  </Button>
                  <Button variant="outline" size="sm" className="transition-all hover:border-primary/50">
                    Remover
              ...
              <Button variant="outline" className="mt-2 transition-all hover:border-primary/50">
        ...
        <Card className="overflow-hidden border-primary/10 shadow-sm">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between p-3 rounded-lg hover:bg-muted/50 transition-all">
              ...
              <Badge className="bg-primary/80 hover:bg-primary">Administrador</Badge>
            </div>
            <div className="flex items-center justify-between p-3 rounded-lg hover:bg-muted/50 transition-all">
              <div className="flex items-center space-x-4">
                <Avatar className="border border-primary/20">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">maria.santos@exemplo.com</p>
                </div>
              </div>
              <Badge variant="outline" className="transition-all hover:bg-primary/10 hover:text-primary">Membro</Badge>
            </div>
            <div className="flex items-center justify-between p-3 rounded-lg hover:bg-muted/50 transition-all">
              <div className="flex items-center space-x-4">
                <Avatar className="border border-primary/20">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">pedro.oliveira@exemplo.com</p>
                </div>
              </div>
              <Badge variant="outline" className="transition-all hover:bg-primary/10 hover:text-primary">Membro</Badge>
            </div>
